...
public class MinistatementActivityAdher extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ministatement_activity_addharwithdraw);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),Deviceadd_activity.class);
                startActivity(intent);
            }
        });
...
//            holder.imageItem.setImageDrawable(mCtx.getResources().getDrawable(ministatementsetget.getImg()));
            ...
            holder.cardId.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(mCtx,Ministatement_seconed.class);
                    startActivity(intent);
                }
            });
        }
