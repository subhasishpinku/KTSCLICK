...
public class Ministatement_thirdactivityy extends AppCompatActivity {
    Button btn_next;
    TextView balance;
    ImageView Img2,Img;
    @Override
    protected void onCreate(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ministatement_activity_mini);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),MinstatementActivitysecomed.class);
                startActivity(intent);
            }
        });
    }
