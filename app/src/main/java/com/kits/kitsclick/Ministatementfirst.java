...
public class Ministatementfirst extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ministatement_activity);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),Deviceaddministatement_activity.class);
                startActivity(intent);
            }
        });
...
//            holder.imageItem.setImageDrawable(mCtx.getResources().getDrawable(ministatementsetget.getImg()));
            ...
            holder.cardId.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(mCtx,Ministatement_seconedd.class);
                    startActivity(intent);
                }
            });
        }
