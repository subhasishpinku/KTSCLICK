...
public class Ministatement_seconedd extends AppCompatActivity {
    TextView balance;
    ImageView Img,Img2;
    Button btn_next;
    ...
    protected void onCreate(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ministatement_activity_seconedd);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),Ministatement_thirdactivityy.class);
                startActivity(intent);
            }
        });
